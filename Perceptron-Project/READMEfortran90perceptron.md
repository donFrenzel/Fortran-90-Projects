...
- A CSV File Reader which takes a .csv file and converts it to a .txt file so that I can then use libdonmat's matrix feature for Perceptron input.  (Preincluded as a module in simplePerceptron.f90).
